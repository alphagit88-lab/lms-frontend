        ...
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-black dark:bg-white text-white dark:text-black py-3 rounded-lg font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="space-y-1 text-xs text-zinc-600 dark:text-zinc-400">
              ...
              <p>Instructor: instructor@lms.com / Instructor@123</p>
              <p>Student: student@lms.com / Student@123</p>
            </div>
          </div>
